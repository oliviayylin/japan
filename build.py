...
DAY_GEO = {
    ...
    "day7": [
        ...
        {"label": "晚餐：札幌螃蟹本家", "lat": 35.1655, "lng": 136.9095},
    ],
    "day8": [
...
EVENT_PHOTO_RULES = {
    ...
    "day2": [
        ...
        ("中田呉服店", "D2-中田呉服店.png"),
        ("白樺莊飯店", "D2-白樺莊飯店晚餐.jpg"),
    ],
    "day3": [
        ("白樺莊飯店", "D3-白樺莊飯店早餐.jpg"),
        ("明神橋", "D3-河童橋.jpg"),
        ("大正池", "D3-大正池.jpg"),
...
JP_HELPER_SECTIONS = [
    {"title": "地名", "type": "vocab", "rows": [
        ...
        ("高山", "たかやま", "Takayama"),
        ("平湯温泉", "ひらゆおんせん", "Hirayu Onsen"),
        ("上高地", "かみこうち", "Kamikochi"),
        ("河童橋", "かっぱばし", "Kappabashi"),
        ("明神", "みょうじん", "Myojin"),
        ("大正池", "たいしょういけ", "Taisho-ike"),
        ("松本", "まつもと", "Matsumoto"),
        ("松本城", "まつもとじょう", "Matsumoto-jo"),
        ("諏訪", "すわ", "Suwa"),
        ("諏訪湖", "すわこ", "Suwako"),
    ...
    {"title": "現場求生句", "type": "sentence", "rows": [
        ("予約しています。12時、大人8名、子供2名です。", "よやくしています。じゅうにじ、おとなはちめい、こどもにめいです。", "我有預約，八大兩小，12點"),
        ("おすすめは何ですか", "おすすめはなんですか", "有什麼推薦的餐點嗎"),
        ("指で教えてもらえますか", "ゆびでおしえてもらえますか", "可以指給我看嗎？"),
