    ...
    <section class="page" id="transit" role="tabpanel" hidden>
      <div class="card geo-card">
        <svg viewBox="0 0 340 460" class="geo-svg" role="img" aria-label="行程地點相對位置與交通時間示意圖">
          ...
          <path d="M35,160 Q45,267 135,375" class="geo-line" fill="none"></path>
          ...
          <g class="geo-label"><rect x="42" y="259" width="46" height="16" rx="8"></rect><text x="65" y="270">2h11</text></g>
